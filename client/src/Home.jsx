              ...
              <Link to={`/restaurant/${restaurant.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
                <div className="card custom-card">
                  ...
                  <div className="card-footer custom-card-footer d-flex justify-content-between">
                    <small className="text-muted"><i className='bi-geo-alt-fill custom-icon'></i>{restaurant.location}</small>
                    <small className="text-muted"><i className="bi bi-star-half custom-icon"></i>Review: {restaurant.review}</small>
                  </div>
                </div>
              </Link>
            </div>
