...
const MyRegistration = () => {
    ...
    const Rworkshop = [
        { id: 1, 
          ...
          image: workshopPic, 
          description: 'A dining venue where an a la carte selection of customary Japanese specialties takes center stage.' , 
    ...
    return(
        <div>
            ...
            <div className="container">
                <br/>
                <div >
                <b> <small onClick={() => navigate(-1)}><i class="bi bi-arrow-left-circle"></i> Back</small></b>
                </div>
            
                <h1 className='custom-h1'>My Schedule</h1>

                <Tabs tabdata={{"one":"Upcoming","two":"Completed","three":"Cancelled"}} activeTab={activeTab} onTabClick={handleTabClick}/>
                <br/>
